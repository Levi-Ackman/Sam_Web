...
## combine all the component so we get the final model SAM(segment anything model), which can be used to 
# predicts object masks from an image and input prompts.
