...
class MaskDecoder(nn.Module):
    ...
    def predict_masks(
        ...
        # print("image_embeddings device name:", image_embeddings.device.type)
        # print("tokens device name:", tokens.device.type)
        ...
        for i, _ in enumerate(range(self.num_mask_tokens)):
            int(i)
