...
from sam import SamAutomaticMaskGenerator, sam_model_registry, SamPredictor
...
sam_checkpoint = "/home/Paradise/Segment_Anything_Webui/checkpoint/sam_vit_h_4b8939.pth" # "sam_vit_l_0b3195.pth" or "sam_vit_h_4b8939.pth"
...
@app.post("/image", summary="Process Images/处理图片ing")
...
@app.post("/click", summary="Click/点击确定分割物体")
...
@app.post("/rect", summary="Bounding box/画框确定分割物体")
...
@app.post("/everything", summary="Segment Everything/分割所有item")
